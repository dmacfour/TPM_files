...
County_Names_and_Regions <- read_excel("~/TPM_SPM_Analysis/Data/newCnR.xlsx")
...
SPM_col_reference <- read.csv("~/TPM_SPM_Analysis/Data/SPM_cols.csv")
...
TPM_col_reference <- read.csv("~/TPM_SPM_Analysis/Data/TPM_cols.csv")
